...
describe("evaluateServicePolicy", () => {
  it("approves allowlisted service under all caps", () => {
    const result = evaluateServicePolicy("/search", 50, policy, 0);
